    ...
    <div className={styles.detailsContainer}>
      <nav className={styles.playerNav}>
        <ul>
          <li>
            <Link href="/players">
              <h1
                className={`${mainStyles["component-title"]} ${styles.playerTitle}`}
              >
                Players
              </h1>
            </Link>
      ...
      {!isLoading && (
        <div className={styles.chartsContainer}>
          <div className={styles.playerStatsContainer}>
            <h2
              className={`${mainStyles.statsSectionHeading} ${styles.performanceHeading}`}
            >
              Performance
            </h2>
      ...
      {!isLoading && (
        <div className={styles.highlightsContainer}>
          <h2
            className={`${mainStyles.statsSectionHeading} ${styles.highlightsHeading}`}
          >
            Highlights Gallery
          </h2>
          <HighlightsCard label="Attacks" pathParam="attacks" />
          <HighlightsCard label="Serves" pathParam="serves" />
          <HighlightsCard label="Defense" pathParam="defense" />
          <HighlightsCard label="Assists" pathParam="assists" />
        </div>
      )}
    </div>
  );
